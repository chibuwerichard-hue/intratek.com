...
// ✅ Updated role-based page access
const ROLE_ACCESS = {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#f7faf7' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px', borderBottom: '1px solid #e8f0e9', background: '#fff', minHeight: '56px' }}>
          <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <button onClick={logout} style={{ padding: '8px 16px', background: '#fff5f5', color: '#c53030', border: '1px solid #fc8181', borderRadius: '8px', fontSize: '12px', fontWeight: 600, cursor: 'pointer' }}>
              🚪 Logout
            </button>
          </div>
        </div>
